...
class Compare {
  ...
  static eq(x, y) {
    return Compare.from(x, OPERATORS.eq, y)
  }
  
  static like(x, y) {
    return Compare.from(x, OPERATORS.like, y)
  }
  
  static lt(x, y) {
    return Compare.from(x, OPERATORS.lt, y)
  }
  
  static lte(x, y) {
    return Compare.from(x, OPERATORS.lte, y)
  }
  
  static gt(x, y) {
    return Compare.from(x, OPERATORS.gt, y)
  }
  
  static gte(x, y) {
    return Compare.from(x, OPERATORS.gte, y)
  }
}
